 ...
 *
 * @method     ChildUserQuery leftJoinRequests($relationAlias = null) Adds a LEFT JOIN clause to the query using the Requests relation
 * @method     ChildUserQuery rightJoinRequests($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Requests relation
 * @method     ChildUserQuery innerJoinRequests($relationAlias = null) Adds a INNER JOIN clause to the query using the Requests relation
 *
 * @method     ChildUserQuery joinWithRequests($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Requests relation
 *
 * @method     ChildUserQuery leftJoinWithRequests() Adds a LEFT JOIN clause and with to the query using the Requests relation
 * @method     ChildUserQuery rightJoinWithRequests() Adds a RIGHT JOIN clause and with to the query using the Requests relation
 * @method     ChildUserQuery innerJoinWithRequests() Adds a INNER JOIN clause and with to the query using the Requests relation
 *
...
abstract class UserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT uid, company, email, username, password FROM user WHERE uid = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_UID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_UID, $keys, Criteria::IN);
    }
     ...
     *
     * @param \Requests|ObjectCollection $requests the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByRequests($requests, $comparison = null)
    {
        if ($requests instanceof \Requests) {
            return $this
                ->addUsingAlias(UserTableMap::COL_UID, $requests->getExtUid(), $comparison);
        } elseif ($requests instanceof ObjectCollection) {
            return $this
                ->useRequestsQuery()
                ->filterByPrimaryKeys($requests->getPrimaryKeys())
                ->endUse();
        } else {
    ...
    {
        if ($user) {
            $this->addUsingAlias(UserTableMap::COL_UID, $user->getUid(), Criteria::NOT_EQUAL);
        }
