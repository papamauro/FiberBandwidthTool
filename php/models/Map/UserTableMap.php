...
class UserTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Uid', 'Company', 'Email', 'Username', 'Password', ),
        self::TYPE_CAMELNAME     => array('uid', 'company', 'email', 'username', 'password', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_UID, UserTableMap::COL_COMPANY, UserTableMap::COL_EMAIL, UserTableMap::COL_USERNAME, UserTableMap::COL_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('uid', 'company', 'email', 'username', 'password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Uid' => 0, 'Company' => 1, 'Email' => 2, 'Username' => 3, 'Password' => 4, ),
        self::TYPE_CAMELNAME     => array('uid' => 0, 'company' => 1, 'email' => 2, 'username' => 3, 'password' => 4, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_UID => 0, UserTableMap::COL_COMPANY => 1, UserTableMap::COL_EMAIL => 2, UserTableMap::COL_USERNAME => 3, UserTableMap::COL_PASSWORD => 4, ),
        self::TYPE_FIELDNAME     => array('uid' => 0, 'company' => 1, 'email' => 2, 'username' => 3, 'password' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        $this->addRelation('Requests', '\\Requests', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':ext_uid',
    1 => ':uid',
  ),
), null, null, 'Requestss', false);
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UserTableMap::COL_UID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(UserTableMap::COL_UID) && $criteria->keyContainsValue(UserTableMap::COL_UID) ) {
